...
#[derive(Debug)]
pub struct BinanceAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BinanceAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BinanceAPI processing");
    
    let mut processor = BinanceAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BinanceAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BinanceAPIProcessor::new(false);
